...
SELECT o.order_ID, o.orderDate, e.firstName || ' ' || e.lastName AS employeeFullName
FROM orders o
...
SELECT o.order_ID, o.order_date || ' ' ||   employeeFullName
FROM orders o
INNER JOIN employees e ON o.employee_ID = e.employee_ID;

SELECT o.orderID, o.orderDate, e.firstName || ' ' || e.lastName AS employeeFullName
FROM orders o
INNER JOIN employees e ON o.employee_ID = e.employee_ID;
...
SELECT o.order_id, o.order_date, e.firstName || ' ' || e.lastName AS employeeFullName
FROM orders o
INNER JOIN employees e ON o.employee_id = e.employee_id;
...
SELECT o.order_id, o.order_date, e.first_name || ' ' || e.last_name AS employeeFullName
FROM orders o
INNER JOIN employees e ON o.employee_id = e.employee_id;
