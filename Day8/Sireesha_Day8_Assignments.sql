/*Day 8,1.Create view vw_updatable_products (use same query whatever I used in the training)
...
CREATE VIEW vw_updatble_products AS
SELECT 
	product_id,
	product_name,
	unit_price,
...
SELECT * FROM vw_updatble_products;

UPDATE vw_updatble_products 
...
BEGIN;
UPDATE products
SET unit_price = unit_price * 0.10
WHERE category_id = 1;
COMMIT;
...
/*Day 8,3.     Create a regular view which will have below details (Need to do joins):
Employee_id,
Employee_full_name,
Title,
Territory_id,
...
/*Day8.4.4.Create a recursive CTE based on Employee Hierarchy*/
